...
func TestReader_Progress(t *testing.T) {
	...
	r := NewPrometheusReader(nil, dir, tailer, nil, targetMap, metadataMap, &nopAppender{}, "", false)
	...
	r = NewPrometheusReader(nil, dir, tailer, nil, targetMap, metadataMap, recorder, "", false)
